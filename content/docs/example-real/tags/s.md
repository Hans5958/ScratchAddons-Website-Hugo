...
Simp, is a straight or cismale who attempts to praise another female, doing whatever it takes to capture the female's attention [1]. Simps tend to use spend all their money and effort in trying to please the girl, even if she doesn't like the man [2]. They usually do things similar to courting, but in a way that embarrasses both the simp and the girl [3]. Simps make up 69% of the straight male population [4].


## sin

{lua:print(math.sin({args}))}

## snot

MEEEEEEEEEEEEEEEEEEEEEEOoOOOOOOOOOOOW
...
**COME ON DOWN TO PITCHSPORK EMPORIUM**
...
Traditional|Left Handed|Fancy
    ---E}  |   {Ǝ---   | ---{}
**I EVEN HAVE DISCOUNTED CLEARANCE SPORKS!**
